...
label scene09:
    ...
    lion "怎么样，Brother？爱情能实现吗？"

    # 莲 「あ。大丈夫だ。行ける」
    lian "啊，可以的，那么我出发了"

    # 里昂 「よし！　い顔になったぞ！　それでこそ私の好きな蓮君だ…！おっと、紛らわしい事は言っちゃいけないね！」
    lion "好！表情看起来不错！这才是我喜欢的莲君啊…！哎呀，不能说容易让人混淆的话啊！"
    ...
    lion "啊，对了。莲君，我希望你能记住这个"

    # 莲 「ん？」
    lian "嗯？"

    # 里昂 「魔法のアイスは『導いてくれる』だけ。恋を叶えるのは…君の、愛っす」
    lion "魔法冰淇淋只能『引导我』，能让爱情成真的…是你的爱"
    ...
    lion "啊哈哈！Awesome！这样的话，在日本就叫做『技あり』吧？（L:技あり，Waza-Ari，半分，这是专门在日本武术“一分 - 半分”比赛（ippon wazari）中通常使用的给分制度，多用于柔道、 空手道、 柔术的最高得分）"
    ...
    lion "Take it Easy！Good luck！慢慢来！我等你的好消息！"
    ...
    ai "我很高兴，太高兴了…莲君，要我成为你的恋人…莲君对我说……"

    # 真冬 「えへへへ…お兄ちゃん…私を…恋人にしてくれるなんて…幸せだよぉ…」
    dong "欸嘿嘿……欧尼酱…竟然把我…当成恋人…真幸福啊…"
    ...
    dong "欧尼酱…那个…那个…就是，说再见之类的事情…对不起……"

    # 莲 「もう、さよならする気はなくなったか？」
    lian "已经不想说再见了吗？"

    # 真冬 「うんっ！　今ので完全になくなったよ！　大好き！　ずっと傍にいるからね、お兄ちゃん！」
    dong "嗯！现在完全没有了！最喜欢了！我会一直在你身边的，欧尼酱！"
    ...
    ai "对对对！恋爱就是进攻才能得到胜利的呢！来~来~嘛呼嘛呼酱~你的感情，让我们也来听一听吧…？"

    # 真冬 「えー…こうされると言いにくいんですけどー…。…よし、じゃぁ、二人とも目を閉じて？」
    dong "嗯……这样很难说出口呢……好吧，那，两个人都把眼睛闭上？"
    ...
    ai "就是啊就是啊！嘛，不过，你已经好好告白了，要给你奖励吗？"

    # 真冬 「おっけ－。じゃぁ、心愛ちゃんそっちをお願いね」
    dong "OK——那，心爱酱，那就拜托你啦"

    # 心爱 「がってん！　さ、もう一度おめとじましょうね～彼氏くん」
    ai "好！那，再一次恭喜我们结为恋人吧~男朋友君"
    ...
    dong "雾叶姐姐？在想瑠喵家里过夜的时候，她和姐姐一起也到想瑠喵家玩了。还有，也看到了想瑠喵的姐姐"

    # 心爱 「ほへー！　マジで！　いないなー！　え、何したの？　５人で。モノポリー？」
    # 参考资料：https://ja.wikipedia.org/wiki/%E3%83%A2%E3%83%8E%E3%83%9D%E3%83%AA%E3%83%BC
    ai "呜欸——！真的！真好啊真好啊！诶，干了什么？5个人，Monopoly？（L:Monopoly其实就是大富翁啦，台湾译作地产大亨，原名Monopoly意为“垄断”，因为最后只有一个胜利者，其余均以破产收场）"

    # 真冬 「んー秘密なんだけどな～…心愛ちゃんだけになら教えてあげてもいよ」
    dong "嗯~虽然是秘密啊~…但是如果只是心爱酱一个人的话，我可以告诉你哦"
    ...
    ai "啊！这里这里这里！我，其实有件很在意的事情！"

    # 真冬 「あ、私も。多分、心愛ちゃんと一緒の疑問だと思う」
    dong "啊，我也是。大概，是和心爱酱一样的疑问吧"
    ...
    ai "我不会生气的！非常好吃，现在也能想起味道！如果可以的话，我还想再吃！"
    ...
    dong "啊…这么说来，我记得我好像是和欧尼酱看到过一次。我觉得这是值得怀疑的东西，但没想到竟然真的有效果…"

    # 心爱 「あうあうあー過ぎた事だけど…あれが自分のしたことだと思うと恥ずかしぃ…」
    ai "啊啊啊啊啊——虽然已经是过去的事情了…但是一想到那是自己做的事情就觉得太羞耻了…"
    ...
    dong "我也是。变成这样的原因，如果是喜欢的心情的话…就算变成瑟琴的心情也不奇怪吧？"

    # 莲 「まぁ…そうなるな…」
    lian "嘛…就这样吧…"

    # 心爱 「それに…アレだよ、蓮くん。彼女としてはね…大好きな彼氏が自分を求めてエッチな気分になってくれたら、素直に嬉しいわけで…」
    ai "而且……就是那个，莲君。作为女朋友……如果最喜欢的男朋友追求自己而产生色情的心情的话，自然会很开心的……"

    # 真冬 「うん…だから、極力拒否はしたくないっていうか…。でも、こじゃ落ち着いて出来ないし…ね？　せっかく恋人になったんだし、初めてはゆっくりまったりしたいよ？」
    dong "嗯…所以，我是尽量不想拒绝的……但是，这里的话就没法冷静下来…对吧？好不容易成为恋人了，第一次还是想慢慢来的哟？"
    ...
    ai "呐。和大家一起啾很多次吧…怎么样？那个时候…我会让你心情变好的…呐，真冬酱"

    # 真冬 「うん。私達をお兄ちゃんの好きにして良いし、して欲しい事あったら…全部、してあげるよ」
    dong "嗯，欧尼酱可以随心所欲地对待我们，如果你有想做的事……全部，都会帮你做的哦"
    ...
    ai "只是我们啊！因为，莲君的心情一直不清楚，所以有点不知所措呢！"

    # 真冬 「ま、もしお兄ちゃんがいつまでも思いを伝えてくれなかったら、二人で付き合っちゃおうかって所までは来てた」
    # L:懂辽！莲你就是多余的那个！
    # W:莲就是应该打酱油的
    dong "嘛，如果欧尼酱一直不告诉我们你的想法，我们两个人就交往了"
