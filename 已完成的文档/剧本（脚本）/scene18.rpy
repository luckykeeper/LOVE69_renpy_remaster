...
label scene18:
    ...
    ai "想瑠喵想瑠喵！莲君问我邀请女生约会该去哪里了！去哪里好呢！"
    ...
    liu "啊？那个啊……你这家伙……在横滨一带到处逛逛街，终点定在游乐园的摩天轮不就好了嘛……（L:横滨有着世界最大的摩天轮）"
    ...
    liu "甚至不是人啊！甚至不是生物啊！你们这样欺负我，我会哭的"
    ...
    liu "话说，从今天开始就放暑假了，我想大家都会登上大人的阶梯…不管发生什么事，老师都不会盖连带保证人的印章，所以要做好准备！"
    ...
    liu "嗯——咳咳，就这样吧。前期课程到此结束！祝大家暑假愉快！"
    ...
    liu "你妹妹和青梅竹马在自己不知情的情况下改变了关系，你不就是想依靠她来填补这个空缺吗？"
    ...
    liu "即使……即使发生任何事？即使她本来就是你无法企及的存在？"
    ...
    liu "吓到你了抱歉啊，这样一来，你现在可能已经猜到了……用一般的办法可是不行的哦，那孩子啊"
    ...
    liu "LOVEPOTION·SIXTININE…连命运都扭曲了…真是的，居然做出了这样的东西……"

    # 想瑠 「あーあ、世界が変わっちまうか…。まぁ、それも面白い。だったら、今夜は派手にお祝いといこうじゃないか。なぁ？」
    liu "啊——啊，世界要改变了嘛……嘛，那也很有趣。那今晚就华丽地庆祝一下吧"

    # 心爱 「あ、想瑠にゃんだ！　何一人でぶつぶつぶやいてるの？」
    ai "啊，是想瑠喵！你一个人在嘟囔什么呢？"
