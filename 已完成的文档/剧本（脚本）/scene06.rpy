...
label scene06:
    ...
    scene 自室a_朝 at love69_bg1440 with ImageDissolve("images/tr/縦ブラインド.png", 1.5, ramplen=128, reverse=True, alpha=True, time_warp=None)
    ...
    dong "哈啊…因为刚才的事情，所以只有下半身变得有精神了呢……"

    # 莲 「不可抗力です…」
    lian "这是不可抗力…"

    # 真冬 「やれやれ…妹にポカリ口移しされて、発情しちゃうなんざ…ほんとダメなお兄ちゃんですね」
    dong "哎呀哎呀…被妹妹嘴对嘴喂了宝矿力就发情…真是个达咩的欧尼酱啊"
    ...
    dong "所以……不要让我再说一遍了，因为我很害羞的啦！如果欧尼酱很痛苦的话……这个…对吧…？"

    # 莲 「い、いのか…？　真冬」
    lian "不是，现在吗…？真冬"

    # 真冬 「うん。だって、心愛ちゃんが居る時にこんな風にされてもアレだし…。別に、一回してるんだから、そこまで恥ずかしくない…でしょ？」
    dong "嗯。因为，心爱酱在的时候这样做应该也没什么…而且咱们已经都做过一次了，所以也不会觉得有什么不好意思吧…？"
    ...
    dong "诶嘿嘿……我啊，真是个⑧行的妹妹呢。欧尼酱要是因为我的行动而兴奋的话……果然会很开心"
    ...
    dong "名字的话就叫カイくん好了（L:カイくん，2003.10.10-2018.6.28，常常出现在电视CM中的一条狗，名字来源于其出身北海道的“海”，最常出现在软银广告中，根据CM研究院2007年CM人才青睐度调查，它在软银CM的人物类别中排名第一）"
    ...
    ai "好，来，Stand Edge！（L:スタンエッジ是「幕末志士達のくにおくん時代劇」游戏里面的一种需要相当高超技术的必杀技）"
