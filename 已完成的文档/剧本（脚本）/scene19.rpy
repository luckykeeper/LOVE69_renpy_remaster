...
label scene19:
    ...
    lion リオン_私服_基本_嬉しい "嗯！话说回来，这是我第一次来观光！之前来日本的时候没那么多空闲…其实这次也没打算去观光，所以非常开心！"
    hide リオン_私服_基本_驚き_1
    ...
    lian "姑且还是遵守日本的法律吧！（当前，日本《民法》第4条规定20岁为成年年龄）"
    ...
    lian "没见过航空母舰，不过如果是核潜艇的话就在邻町的横须贺（L:横须贺的美军基地有停靠核动力潜艇，翻译时最近一次是在2022年1月10日）"
    ...
    lion リオン_私服_基本_微笑み "然后，我把这件事告诉了爸爸，他非常生气……啊，这是理所当然的啊，一个小女孩的爱情，竟然想歪曲世界的道理……"
