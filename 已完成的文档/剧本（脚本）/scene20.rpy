...
label scene20:
    ...
    lion "是啊…我第一次看到这种真正的间接照明…（L:间接照明很多人应该都知道，不知道的请问度娘）"
    ...
    lion "没有啊。一般来说，我都会在便宜的汽车旅馆里，用沾有污点的被子，度过让人想忘却的夜晚"

    # 莲 「…経験あるのか？」
    lian "…有经验吗？"

    # 里昂 「さぁーどうでしょう！…にへ、なーいよ♪　男の人とチューするのも、これがはじめてだよ」
    lion "那么，怎么样！…欸嘿嘿，没有哦♪跟男人亲吻也是，这是第一次哦"
    ...
    # 里昂 「そう言いながら、リオンは部屋のカーテンを開いた。」
    lion "这样说着，里昂打开了房间的窗帘"
