...
label scene03:
    ...
    if persistent.luckykeeperSay == "shutup":
        "去公园的时候，明明没有食物，鸽子却成群结队地聚集在边上，明明是在挖红薯，却发掘出来了土偶，明明是敲了小鼓，响的却是脚踏钹"
    else:
        "去公园的时候，明明没有食物，鸽子却成群结队地聚集在边上，明明是在挖红薯，却发掘出来了土偶（L:是人形陶土制品，日本绳文时代的代表性遗物），明明是敲了小鼓，响的却是脚踏钹（L:这两样都是架子鼓上面的乐器）"
    ...
    if persistent.luckykeeperSay == "full":
        ...
        ai 心愛_制服_基本_無表情 "而且是51型家庭影院，7.1声道环绕声系统"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_制服_基本_笑顔 "锵——锵！我试着在番茄和马苏里拉奶酪的意大利面上加上了罗勒和橄榄"
    else:
        ai 心愛_制服_基本_笑顔 "锵——锵！我试着在番茄和马苏里拉奶酪（L:是一种源自于意大利南部城市坎帕尼亚和那不勒斯的淡奶酪）的意大利面上加上了罗勒（L:是一类可用于烹调的香草，广东潮汕称为“金不换”、“鱼生菜”，皖北称为“香花子”，我国北方部分地区又称之为“兰香”）和橄榄"
    ...
    ai 心愛_制服_基本_不機嫌 "唔，嗯…！那么，为了我能平安度过今天剩下的日子，我只说一次！被喜、喜欢的人！要求的事是！非常的！开心！虽然确实很不好意思！"
    hide 心愛_制服_基本_泣き
