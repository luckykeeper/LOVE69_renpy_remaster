...
label scene10:
    ...
    if persistent.luckykeeperSay == "shutup":
        lian "不过好厉害啊。我是第一次坐DeLorean。而且中途还飞了起来"
    else:
        lian "不过好厉害啊。我是第一次坐DeLorean。（L:德罗宁汽车，1975-1982，成名于在世界各地广受欢迎的《回到未来系列》电影（前面有提到）），而且中途还飞了起来"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_不機嫌 "『之前在penny auction上有卖的哦』"
    else:
        ai 心愛_yシャツ_パンツ有り_不機嫌 "『之前在penny auction上有卖的哦』（L:指“一分钱拍卖”始于德国的Swoopo，口号是“娱乐消费”，模式类似于京东拍拍的夺宝岛，上面所有商品起价统一0.15刀，每次加价为0.75刀，每多一名参与者价格上涨0.15刀，20秒没人新出价即成交）"
    ...
    if persistent.luckykeeperSay == "shutup":
        dong 真冬_裸yシャツ_基本_無表情 "『那个还是算了吧。时间快到了运营就来钓鱼了，反正也买不起』"
    else:
        dong 真冬_裸yシャツ_基本_無表情 "『那个还是算了吧。时间快到了运营就来钓鱼了，反正也买不起』（L:海鲜市场(闲鱼)·拍拍·转转等拍卖平台的卖家，常常会开小号，如果价格不满意就用小号加价，保证自己不亏）"
    ...
    if persistent.luckykeeperSay == "full":
        ...
        ai 心愛_yシャツ_パンツ有り_驚き "『什么！我被艺人的博客欺骗了！』"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_真顔 "『我的侄子说他不知道什么是钱，所以他问我这是不是雏祭的雏刀。我觉得它很可爱，所以我把它给了他，而他去买了一个烤红薯吃』"
    else:
        ai 心愛_yシャツ_パンツ有り_真顔 "『我的侄子说他不知道什么是钱，所以他问我这是不是雏祭的雏刀。我觉得它很可爱，所以我把它给了他，而他去买了一个烤红薯吃』（L:这里同样是引用了古代落语，出自三代目三遊亭的『雛鍔』，发布于1733年感兴趣可以去找找这个东西的落语，本作非常喜欢引落语相关的东西呢）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_真顔 "『前辈！这个龙纹的平角内裤是！』"
    else:
        ai 心愛_yシャツ_パンツ有り_真顔 "『前辈！这个龙纹的平角内裤是！』（L:前面有提到的莲君的胖次）"
    ...
    if persistent.luckykeeperSay == "shutup":
        dong 真冬_裸yシャツ_基本_無表情 "『去舔舔玄关边上的盐吧——！』"
    else:
        dong 真冬_裸yシャツ_基本_無表情 "『去舔舔玄关边上的盐吧——！』（L:中国的一个传说传到了日本，人们开始认为盐是一种邀请客人和带来好运的方式，即使在今天，在传统的餐馆、旅店等地人们在打扫过的门口两边放上一小堆盐，以带来好运）"
    ...
    # luckykeeper "果然，牛停下来舔盐，不愿意动。皇帝于是说：“今晚就选这了”，然后去了那个女人的房间，她在那里得到了皇帝的宠幸"
        luckykeeper "果然，牛停下来舔盐，不愿意动。皇帝于是说：“今晚就选这了”，然后去了那个女人的房间，她在那里得到了皇帝的宠幸"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_真顔 "好，准备好Take 2！"
    else:
        ai 心愛_yシャツ_パンツ有り_真顔 "好，准备好Take 2！（L:这里不是前面提到的喜剧二人组テイク２，是重来第二次的意思，常见于拍戏）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_もぐもぐ "咕呜咕呜咕呜咕呜。果然还是福岛的米好吃啊！"
    else:
        ai 心愛_yシャツ_パンツ有り_もぐもぐ "咕呜咕呜咕呜咕呜。果然还是福岛的米好吃啊！（L:这里应该是指福岛县，核电站是2011年的事，本作是2013年的，根据农林水产省提供的统计数据(2009)，福岛县出产948亿日元的大米(日本第五)，福岛市第一产业占日本第一）"
    ...
    if persistent.luckykeeperSay == "shutup":
        dong 真冬_裸yシャツ_基本_微笑み "来，是气仙沼的金枪鱼和鲣鱼"
    else:
        dong 真冬_裸yシャツ_基本_微笑み "来，是气仙沼的金枪鱼和鲣鱼（L:气仙沼市，位于日本宫城县东北端，以盛产鱼翅而闻名）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_yシャツ_パンツ有り_にっこり "出生和成长都在东北地区！"
    else:
        ai 心愛_yシャツ_パンツ有り_にっこり "出生和成长都在东北地区！（L:东北地方是日本本州岛上的一个地区，因位于本州的东北部而得名，前面提到的福岛县、气仙沼市、宫城县都属于东北地区）"
    ...
    # lian "什么啊，一惊一乍的（L:原话“从灌木丛中伸出一根棍子” 这个谚语是说言行、故事突兀，让人摸不到头脑，或者也可以说突然被别人吓着了，这个说法在前面Scene01的时候莲也这么说过）"
    # lian "什么啊，一惊一乍的（L:原话“なんだ藪から棒に” 这个谚语是说言行、故事突兀，让人摸不到头脑，或者也可以说突然被别人吓着了，这个说法在前面Scene01的时候莲也这么说过）"
    if persistent.luckykeeperSay == "shutup":
        lian "什么啊，一惊一乍的"
    else:
        lian "什么啊，一惊一乍的（L:原话“なんだ藪から棒に” 这个谚语是说言行、故事突兀，让人摸不到头脑，或者也可以说突然被别人吓着了，这个说法在前面Scene01的时候莲也这么说过）"
    ...
    ai 心愛_yシャツ_パンツ有り_驚き "呜欸——！这么直球地告诉他们真的没关系嘛！？"
    ...
    dong 真冬_裸yシャツ_基本_無表情 "真的是这样的想法吗？要是看我们的屁股看得入迷的话，倒是觉得不好意思才有意义吧"
    hide 真冬_裸yシャツ_基本_目閉じ
    ...
    if persistent.luckykeeperSay == "shutup":
        dong 真冬_裸yシャツ_基本_キス "那我就先来和欧尼酱亲一下吧？来，欧尼酱，啾——"
    else:
        dong 真冬_裸yシャツ_基本_キス "那我就先来和欧尼酱亲一下吧？来，欧尼酱，啾——（L:这里真冬的CV也少说了一段捏）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai_dong 真冬_裸yシャツ_基本_微笑み "『Jackpot！』"
    else:
        ai_dong 真冬_裸yシャツ_基本_微笑み "『Jackpot！（L:正中头奖！，一般形容彩票等需要碰运气的头奖）』"
    ...
    if persistent.luckykeeperSay == "full":
        ...
        ai 心愛_yシャツ_パンツ有り_笑顔 "好耶！来来——那么，开张啦！"
    ...
    lian "emmmm……什么啊，今天是有什么喜事儿还是什么大日子啊……？"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_私服_基本_嬉しい "ＵＳＪ的辣个，魔法学校的那个！"
    else:
        ai 心愛_私服_基本_嬉しい "ＵＳＪ的辣个，魔法学校的那个！（L:大版的环球影城，有霍格沃茨魔法学校，感兴趣的百度一下就有）"
    ...
    # lian "那个还没建好呢（L:2013年的时候还没有完全建好）…还有，拜托你想个一日游能到达的距离"
    if persistent.luckykeeperSay == "shutup":
        lian "那个还没建好呢…还有，拜托你想个一日游能到达的距离"
    else:
        lian "那个还没建好呢（L:2013年的时候还没有完全建好）…还有，拜托你想个一日游能到达的距离"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_私服_基本_笑顔 "Disney！"
    elif persistent.luckykeeperSay == "meme":
        ai 心愛_私服_基本_笑顔 "Disney！（L:霓虹人很喜欢传一些「CP去了就会分手的地方」，迪士尼和刚才提到的ＵＳＪ都有入选，原因是因为人太多了，等待时间太长，CP面面相觑，无话可说，压力会比较大，容易上头）"
    else:
        ai 心愛_私服_基本_笑顔 "Disney！（L:法务部发来律师函(doge)；霓虹人很喜欢传一些「CP去了就会分手的地方」，迪士尼和刚才提到的ＵＳＪ都有入选，原因是因为人太多了，等待时间太长，CP面面相觑，无话可说，压力会比较大，容易上头）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_私服_基本_真顔 "其实我很喜欢Puroland呢…"
    else:
        ai 心愛_私服_基本_真顔 "其实我很喜欢Puroland呢…（L:Sanrio Puroland，东京的三丽鸥彩虹乐园）"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_私服_基本_笑顔 "也把胡子全部剃掉吧！但是只能用双刃刀"
    else:
        ai 心愛_私服_基本_笑顔 "也把胡子全部剃掉吧！但是只能用双刃刀（L:1971年左右，吉列推出了双刃剃须刀，虽然说双刃刀属于安全剃刀，但是刀片锋利，误操作还是容易刮伤自己）"
    ...
    if persistent.luckykeeperSay == "full":
        lianaidong 真冬_私服_基本_無表情 "『你原来会说话啊！？』"
    else:
        lianaidong 真冬_私服_基本_無表情 "『你原来会说话啊！？』（L:蚌埠住了）"
