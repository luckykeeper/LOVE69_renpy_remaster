...
label scene21:
    ...
    "与里昂相遇（重逢）的那一天，如果按照原定计划的话，我会和真冬还有心爱一起去吃饭的那家diner式西餐厅"

    # nil 「なんつー因果だ…。結局、あれから色々あって訪れる機会を失ってはいたが…。」
    # "这就是命运啊……后来，由于各种原因，我一直没有机会去这里……"
    "这就是命运啊……后来，由于各种原因，我一直没有机会来这里……"
    ...
    lion リオン_私服_基本_にっこり "对对，积攒了一个星期终于……真是笨蛋啊！是紧张什么的！"
    hide リオン_私服_基本_ぶわー
    ...
    "虽然里昂不情愿，但我还是强行拉着她的手，穿过挂着『OPEN』牌子的门"
    ...
    "店内装饰着美国特色的商品和霓虹灯，金属制的吧台前摆放着画有可乐标志的圆形椅子"
    ...
    "虽然不知道她们签的协议是什么，但是我们是来传达约定失败了的消息"
    ...
    dinerowner 店长_私服_不満 "又有麻烦的人来了，请快离开吧"
    hide 店长_私服_目閉じ
    ...
    liu 想瑠_スーツ_本気 "就是你这家伙啊葛城哥哥！刚才还嘟囔了『除了我们没有其他客人了吗』之类的话吧！"
    hide 想瑠_スーツ_ぶわ
    ...
    dinerowner 店长_私服_目閉じ "啊，是啊。真是的，不要在重要的地方打断我的话。来，给你瓶可乐"
    hide 店长_私服_無表情
    ...
    liu 想瑠_スーツ_見下し "等我们从夏威夷旅行回来再说吧，不是挺好的嘛？"
    hide 想瑠_スーツ_驚き
    ...
    "结果，做了H的事情也只有和里昂在一起的当天，那之后忙得连想都没想过"
