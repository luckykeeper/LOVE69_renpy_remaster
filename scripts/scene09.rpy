...
label scene09:
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_下着_基本_驚き "不要说这说那了！快把这家伙藏起来！"
    else:
        ai 心愛_下着_基本_驚き "不要说这说那了！快把这家伙藏起来！（L:前半句原文「四の五の言ってないの！」四の五の言的说法起源于江户时代中期的骰子赌博游戏，也有来自四书五经的说法，意思是对某件事情抱怨，感兴趣的可以去自行Yahoo~）"
    ...
    if persistent.luckykeeperSay == "shutup":
        "我独自坐在客厅里，试图找出Milo和牛奶的完美组合，等待真冬归来，现在是晚上11点"
    else:
        "我独自坐在客厅里，试图找出Milo（L:一种由瑞士雀巢公司出品的奶类饮料，含有巧克力和麦芽成分，最早是1934年澳洲人托马斯研发）和牛奶的完美组合，等待真冬归来，现在是晚上11点"
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_制服_基本_真顔 "不，今天是在军舰上用勺子盛装三文鱼子的打工"
    else:
        ai 心愛_制服_基本_真顔 "不，今天是在军舰上用勺子盛装三文鱼子的打工（L:这里说的是军舰寿司）"
    ...
    if persistent.luckykeeperSay == "shutup":
        liu 想瑠_スーツ_見下し "哈啊……哈啊…你要学会除了武力以外的说服方法……不过嘛，因为被封口了，所以不能说"
    else:
        liu 想瑠_スーツ_見下し "哈啊……哈啊…你要学会除了武力以外的说服方法……不过嘛，因为被封口了，所以不能说（L:这里的后半句原版也是没有配音）"
    ...
    if persistent.luckykeeperSay == "shutup":
        liu 想瑠_スーツ_見下し "什么？难道我不该去夏威夷吗？我可是怀哈的戈伊斯"
    else:
        liu 想瑠_スーツ_見下し "什么？难道我不该去夏威夷吗？我可是怀哈（L:怀哈是夏威夷，怀哈（Waiha）是泰国苏梅岛的一种死语（就是因为没有人用所以消失的语言）对夏威夷的说法）的戈伊斯（L:音译，漫画鼻毛真拳中毛の王国里面的一个人物）"
    ...
    if persistent.luckykeeperSay == "shutup":
        liu 想瑠_スーツ_中指 "就是这种气势。Adiós・fxxking・amigo"
    else:
        liu 想瑠_スーツ_中指 "就是这种气势。Adiós・fxxking・amigo（又是西班牙语，Adiós=再见，amigo=友人(一般指没有血缘关系的友人)）"
    ...
    dong 真冬_制服_基本_微笑み "可是，可是，即使是现在，我还是想追求这种幸福。所以，我就不想和欧尼酱和心爱酱说话了"
    ...
    if persistent.luckykeeperSay == "shutup":
        lion リオン_基本_杖_微笑み "呐，迈克尔，你看那个……是2013年款的呢……"
    else:
        lion リオン_基本_杖_微笑み "呐，迈克尔，你看那个……是2013年款的呢……（L:和本作发售同年）"
    ...
    lion リオン_基本_杖_微笑み "自我牺牲的精神固然很好，但是坦率地说出自己的心声也很重要。这是因为武士与忍者国度的人的习惯的原因吗？"
    ...
    luckykeeper "关于接下来将要播放的嵌入式 STAFF 表的说明：\n
        接下来将要播放 STAFF 表，原作的 STAFF 表是由1496张加密的不透明的jpg图片组成，经过抠图处理，得到了1457张并不完美的带alpha通道的WebP图片，原作的这种播放方式并不适应Ren’Py引擎的设计"

    luckykeeper "所以为了正常播放 STAFF 表，这里程序会破例使用设备最大内存来对图形进行加载，但是为了完整的游戏体验，建议选择显示 STAFF 表，请您提前存档以防万一"

    luckykeeper "如果你正在使用低性能设备（尤其是低内存设备），您可以选择不显示 STAFF 表来加快运行速度\n如果你正在使用较老的安卓设备，强烈建议不显示 STAFF 表，否则可能会触发安卓内存回收机制"
    ...
    lion リオン_基本_杖_嬉しい "将身体交织在一起，紧密联系起来，这是爱情的最高表现。她们向你如此寻求的原因是……你是被爱着的呢"
    ...
    if persistent.luckykeeperSay == "shutup":
        lion リオン_基本_杖_嬉しい "虽然不知道要过多长时间。如果我有了自己的店，我们就可以随时见面了！然后你们三个人就一起来玩吧！我等着你！"
    else:
        lion リオン_基本_杖_嬉しい "虽然不知道要过多长时间。如果我有了自己的店，我们就可以随时见面了！然后你们三个人就一起来玩吧！我等着你！（L:这里原作就缺少前面的配音）"
    ...
    if persistent.luckykeeperSay == "shutup":
        lion リオン_基本_杖_にっこり "魔法冰淇淋只能『引导我』，能让爱情成真的…是你的爱"
    else:
        lion リオン_基本_杖_にっこり "魔法冰淇淋只能『引导我』，能让爱情成真的…是你的爱（L:这里玩了个谐音梗233）"
    ...
    if persistent.luckykeeperSay == "shutup":
        lion リオン_基本_杖_微笑み "啊哈哈！Awesome！这样的话，在日本就叫做『技あり』吧？"
    else:
        lion リオン_基本_杖_微笑み "啊哈哈！Awesome！这样的话，在日本就叫做『技あり』吧？（L:技あり，Waza-Ari，半分，这是专门在日本武术“一分 - 半分”比赛（ippon wazari）中通常使用的给分制度，多用于柔道、 空手道、 柔术的最高得分）"
    ...
    dong 真冬_制服_基本_見下し4 "你这家伙难道和我还有商量的余地吗？"
    hide 真冬_制服_基本_にっこり_1
    ...
    if persistent.luckykeeperSay == "shutup":
        ai 心愛_制服_基本_ポカーン "呜欸——！真的！真好啊真好啊！诶，干了什么？5个人，Monopoly？"
    else:
        ai 心愛_制服_基本_ポカーン "呜欸——！真的！真好啊真好啊！诶，干了什么？5个人，Monopoly？（L:Monopoly其实就是大富翁啦，台湾译作地产大亨，原名Monopoly意为“垄断”，因为最后只有一个胜利者，其余均以破产收场）"
    ...
    ai 心愛_制服_基本_微笑み "而且……就是那个，莲君。作为女朋友……如果最喜欢的男朋友追求自己而产生H的心情的话，自然会很开心的……"
    hide 心愛_制服_基本_真顔
    ...
    # "那只会让我的人生变得寂寞……能够阻止真是太好了，现在的我根本无法考虑和你们两人以外的人交往"
    lian "那只会让我的人生变得寂寞……能够阻止真是太好了，现在的我根本无法想象和你们两人以外的人交往的感觉"
    ...
    # "我这样告诉孩子，以crouch start（L:蹲踞式起跑，1896年雅典奥运会上美国田径运动员托玛斯·伯克创造的起跑方法，目前短跑比赛中普遍采用“蹲踞式”的起跑技术）赶回了家"
    # "我这样告诉弟弟，以crouch start（L:蹲踞式起跑，1896年雅典奥运会上美国田径运动员托玛斯·伯克创造的起跑方法，目前短跑比赛中普遍采用“蹲踞式”的起跑技术）赶回了家"
    # "我这样告诉儿子，以crouch start（L:蹲踞式起跑，1896年雅典奥运会上美国田径运动员托玛斯·伯克创造的起跑方法，目前短跑比赛中普遍采用“蹲踞式”的起跑技术）赶回了家"
    if persistent.luckykeeperSay == "shutup":
        "我这样告诉儿子，以crouch start赶回了家"
    else:
        "我这样告诉儿子，以crouch start（L:蹲踞式起跑，1896年雅典奥运会上美国田径运动员托玛斯·伯克创造的起跑方法，目前短跑比赛中普遍采用“蹲踞式”的起跑技术）赶回了家"
