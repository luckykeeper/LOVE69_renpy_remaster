...
| -------------------- | ------------------------------------------------------------ |
| 状态                 | 进行中（正式版开发中）<br/>Scene 01（Demo）部分文本内容翻译完成（2021年10月1日）<br/>Demo 版制作完成，开始内部测试（2021年10月9日）<br/>Demo 版发行（2021年10月24日）<br/>Scene 02 翻译完成（2021年11月6日） |
