...
- [x] 通过游玩汉化版的作品，感受 LOVEPOTION SIXTYNINE 的魅力（目前 Demo 版已经完成，翻译已经全部完成，GUI重构基本完成！可以到[实机开发画面展示](#实机开发画面展示)预览）【[下载戳这里](https://github.com/luckykeeper/LOVE69_renpy_remaster/releases/tag/0.1.0)，建议优先选择国内节点】
